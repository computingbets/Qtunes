...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetSong = function onGetSong(event) {
	  event.preventDefault();
	  ...
	  // .done(ui.success)
	  // .fail(ui.failure);
	  api.createPlaylist(data).done(ui.createPlaylistSuccess).fail(ui.failure);
	};

	var onDisplayPlaylist = function onDisplayPlaylist(event) {
	  event.preventDefault();
	  console.log("HI");
	  api.displayPlaylist().done(ui.displayPlaylistSuccess).fail(ui.failure);
	};

	var onUpdateSong = function onUpdateSong(event) {
	  event.preventDefault();
	  var songIDUpdate = $('#update-song-id').val();
	  var updateTitle = $('#update-title').val();
	  var updateArtist = $('#update-artist').val();
	  var updateLinks = $('#update-links').val();
	  api.updateSong(songIDUpdate, updateTitle, updateArtist, updateLinks).done(ui.success).fail(ui.failure);
	};

	var onDeletePlaylist = function onDeletePlaylist(event) {
	  event.preventDefault();
	  api.deletePlaylist().done(ui.deleteSuccess).fail(ui.failure);
	};
	...
	var onNavSignIn = function onNavSignIn() {
	  $('#open-sign-in').modal('show');
	};

	var onNavOptions = function onNavOptions() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateSong = function updateSong(songIDUpdate, updatedTitle, updatedArtist, updatedLinks) {
	  return $.ajax({
	...
	var getSong = function getSong(data) {
	  return $.ajax({
	...
	var createPlaylist = function createPlaylist(data) {
	  return $.ajax({
	    url: app.host + '/playlists',
	    method: 'POST',
	    dataType: 'json',
	...
	var updatePlaylist = function updatePlaylist(data, playlistData) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var api = __webpack_require__(5);
	var handlebarsTemplate = __webpack_require__(8);
	...
	var displaySongsSuccess = function displaySongsSuccess(data) {
	  console.log(data);
	  $('#playlist-display').append(handlebarsTemplate({ data: data }));
	};
	...
	var playlistData = "";
	var createPlaylistSuccess = function createPlaylistSuccess(data) {
	  console.log(data);
	...
	var displayPlaylistSuccess = function displayPlaylistSuccess(data) {
	  console.log(data);
	...
	module.exports = {
	  ...
	  displayPlaylistSuccess: displayPlaylistSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <p>song id: "
	    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.playlist : stack1)) != null ? stack1.song : stack1)) != null ? stack1.id : stack1), depth0))
	    + "</p>\n  <p>title : "
	    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.playlist : stack1)) != null ? stack1.song : stack1)) != null ? stack1.title : stack1), depth0))
	    + "</p>\n  <p>artist : "
	    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.playlist : stack1)) != null ? stack1.song : stack1)) != null ? stack1.artist : stack1), depth0))
	    + "</p>\n  <p>tunage link : "
	    + alias2(alias1(((stack1 = ((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.playlist : stack1)) != null ? stack1.song : stack1)) != null ? stack1.links : stack1), depth0))
	    + "</p>\n";
	},"useData":true});
